...
#ifndef STATE_MACHINE_COMMAND_CONTROLLER__STATE_MACHINE_CONTROLLERS_BASE_HPP_
#define STATE_MACHINE_COMMAND_CONTROLLER__STATE_MACHINE_CONTROLLERS_BASE_HPP_
 ...
 */
class StateMachineControllersBase : public controller_interface::ControllerInterface
{
public:
  STATE_MACHINE_COMMAND_CONTROLLER_PUBLIC
  StateMachineControllersBase();

  STATE_MACHINE_COMMAND_CONTROLLER_PUBLIC
  ~StateMachineControllersBase() = default;
...
#endif  // STATE_MACHINE_COMMAND_CONTROLLER__STATE_MACHINE_CONTROLLERS_BASE_HPP_
